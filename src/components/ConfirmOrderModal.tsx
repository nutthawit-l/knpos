    ...
    <div className="absolute inset-0 bg-black/45 flex items-center justify-center z-50 px-6 rounded-[24px]">
      <div className="bg-white rounded-2xl w-full max-w-[327px] overflow-hidden flex flex-col">
        ...
        <div className="p-5 flex gap-3 w-full">
          <button
            onClick={onCancel}
            className="flex-1 bg-white border border-gray-200 rounded-xl py-2.5 text-foreground font-semibold text-sm text-center"
          >
            Cancel
          </button>
          <button
            onClick={onConfirm}
            className="flex-1 bg-primary rounded-xl py-2.5 text-white font-semibold text-sm text-center"
          >
            Confirm
          </button>
        </div>
